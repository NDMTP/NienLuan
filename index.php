                ...
                <div class="grid-panel">
                        ...
                        <ul class="list-media">
                            <li>
                                <div class="biolife-banner grid biolife-banner__grid type-02 bn-elm-02">
                                    <a href="product-detail.php?id=TC10" class="media-contain media-02"></a>
                                    <div class="banner-contain">
                                        <a href="product-detail.php?id=TC10" class="cat-name">Dâu Tây</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="grid-panel-item right-content">
                        <div class="biolife-banner grid biolife-banner__grid type-02 bn-elm-06">
                            <a href="product-detail.php?id=TC11" class="media-contain media-06"></a>
                            <div class="banner-contain">
