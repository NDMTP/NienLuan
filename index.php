        ...
        <div id="main-content" class="main-content">
                    ...
                    <li>
                        <div class="slide-contain slider-opt03__layout01 mode-03 black-color slide-bgr-mode03-01">
                            ...
                            <div class="text-content">
                                ...
                                <h3 class="second-line">Nước trái cây tươi. 100% hữu cơ</h3>
                                <p class="third-line">Hỗn hợp táo xanh và trái cây tươi ép</p>
                                <p class="buttons">
                                    <a href="#" class="btn btn-bold">Ghé shop ngay</a>
                                    <a href="#" class="btn btn-thin">Xem thêm chi tiết</a>
                                </p>
                            </div>
                        </div>
                    </li>
                        ...
                        <ul class="list-media">
                            <li>
                                <div class="biolife-banner grid biolife-banner__grid type-02 bn-elm-02">
                                    ...
                                    <div class="banner-contain">
                                        <a href="#" class="cat-name">Dâu Tây</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="biolife-banner grid biolife-banner__grid type-02 bn-elm-04">
                                    ...
                                    <div class="banner-contain">
                                        <a href="#" class="cat-name">Mâm Xôi</a>
                                    </div>
                                </div>
                            </li>
                            <li>
            ...
            <div class="product-tab z-index-20 sm-margin-top-49px xs-margin-top-80px">
                <div class="container">
                    <div class="biolife-title-box biolife-title-box__icon-at-top-style hidden-icon-on-mobile">
                        ...
                        <h3 class="main-title">Sản phẩm bán chạy</h3>
                    </div>
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":1 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":30}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "rows":2, "slidesMargin":15}}]}'>
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Nước ép Cam</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">NƯỚC ÉP VFRESH </a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>49.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>69.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Thương hiêu Vfresh, Sản xuất tại: Việt Nam, Thành phần: Nước trái cây ép từ nước trái cây cô đặc, hương liệu tổng hợp dùng cho thực phẩm.,.</p>
                                                    <div class="buttons">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/products/p-01.png" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">Nước ép cam</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Nước Ép Cam Hỗn Hợp Có Tép Cam Malee 1 L</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>65.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>95.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Hương vị thơm ngon Giàu vitamin C, khoáng chất Giàu dưỡng chất thiết yếu cho cơ thể Liên hệ trực tiếp để được giá sỉ tốt nhất.</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Nước ép cam</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Nước Cam Ép 10% Twister Chai 350ml</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>11.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>20.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Thành phần tự nhiên, an toàn Hương vị thơm ngon, kích thích vị giác Đóng chai nhỏ gọn, tiện lợi khi sử dụng</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Nước ép cam</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Nước TEPPY cam tép 1L</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>25.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>35.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Nước TEPPY cam được chiết xuất từ những trái cam tự nhiên, sản phẩm có m</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                    ...
                    <div class="container">
                        <div class="banner-contain">
                            ...
                            <div class="text-content">
                                ...
                                <span class="text03">Thiên đường hữu cơ</span>
                                <span class="text04">Easy <i>Healthy, Happy Life</i></span>
                                <div class="product-detail">
                                    <h4 class="product-name">Sản xuất trái cây tươi quốc gia</h4>
                ...
                <div class="biolife-banner promotion6 biolife-banner__promotion6">
                    <div class="banner-contain">
                        ...
                        <div class="text-content">
                            ...
                            <b class="text2">100% TỰ NHIÊN NGUYÊN CHẤT</b>
                            <p class="buttons">
                                <a href="#" class="btn btn-thin">Đặt hàng ngay</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="biolife-tab biolife-tab-contain">
                        <div class="tab-head tab-head__sample-layout type-02 xs-margin-bottom-15px ">
                            <ul class="tabs">
                                ...
                                <li class="tab-element" >
                                    <a href="#tab01_2nd" class="tab-link">Top bán chạy</a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_3rd" class="tab-link">Đang SALE</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":2 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin": 30}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin": 15}}]}'>
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Thực phẩm</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Yến mạch</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>85.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>95.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Tốt cho sức khỏe, giúp giảm cân</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Thực phẩm</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Hạt dẻ sấy khô</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>125.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>195.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Bổ sung năng lượng cần thiết cho sức khỏe.</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <h4 class="product-title"><a href="#" class="pr-name">Dâu tây</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>250.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>325.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message"> Dâu tây rất giàu chất xơ và vitamin C, một cặp chất dinh dưỡng tuyệt vời để giảm stress oxy hóa, có thể hỗ trợ làm giảm nguy cơ mắc bệnh tim</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Thực phẩm</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Cam sấy khô</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>60.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>95.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Cam sấy khô có chứa rất nhiều chất xơ, magie và rất nhiều các hợp chất thực vật khác có lợi cho sức khỏe, điều này sẽ giúp cơ thể bạn kiểm soát được lượng đường trong máu, giảm tình trạng huyết áp cao và mức cholesterol trong máu..</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Thực phẩm</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Trái cây sấy tổng hợp</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>185.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>295.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Trái cây sấy tổng hợp chứa nhiều chất dinh dưỡng cho cơ thể.</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>65.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>85.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Khoai lang chứa lượng vitamin, khoáng chất, chất xơ và carbohydrate cao có tác dụng hỗ trợ chữa lành các vết loét dạ dày và ruột, điều trị ...</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Trái cây</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Dâu tây Đà lạt </a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>140.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>195.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Dâu tây rất giàu chất xơ và vitamin C, một cặp chất dinh dưỡng tuyệt vời để giảm stress oxy hóa, có thể hỗ trợ làm giảm nguy cơ mắc bệnh tim.</p>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <b class="categories">Rau củ</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Cà rốt</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">đ</span>14.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">đ</span>19.000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Cà rốt là một loại rau củ tốt cho sức khỏe, với độ giòn, vị ngon và chứa rất nhiều beta carotene, chất xơ, vitamin K1, kali cũng như chất chống oxy hóa.
                                                        .</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
            ...
            <div class="blog-posts sm-margin-top-49px xs-margin-top-60px">
                <div class="container">
                    <div class="biolife-title-box biolife-title-box__bold-center xs-margin-bottom-50px sm-margin-bottom-0-im">
                        <i class="subtitle">Tin tức mới nhất và nổi bật nhất</i>
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02 ">
                                ...
                                <div class="post-content">
                                    <h4 class="post-name"><a href="#" class="linktopost"> Những loại rau củ người bị sỏi thận cần tránh</a></h4>
                                    <div class="post-meta">
                                        <a href="#" class="post-meta__item author"><img src="assets/images/home-03/post-author.png" width="28" height="28" alt=""><span>Lương Lưu Minh Tân</span></a>
                                    ...
                                    <p class="excerpt">Người bị sỏi thận nên hạn chế ăn rau cải bó xôi, củ cải đường, đậu bắp, rau dền vì dễ làm tăng lượng oxalat, khiến sỏi thận khó đào thải ra ngoài... </p>
                                    <div class="group-buttons">
                                        <a href="#" class="btn readmore">Đọc tiếp</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="banner-contain">
                        <div class="container">
                            <div class="biolife-title-box bgrd-bold biolife-title-box__bgrd-bold">
                                <h3 class="title">Nước trái cây</h3>
                            </div>
                            <ul class="products-list vertical-layout-02 biolife-carousel nav-none-on-mobile" data-slick='{"rows":3,"arrows":false,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":1, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 1}},{"breakpoint":768, "settings":{ "slidesToShow": 3, "rows":2, "slidesMargin":10}},{"breakpoint":500, "settings":{ "slidesToShow": 2, "rows":2, "slidesMargin":15}}]}'>
                                <li class="product-item">
                                    <div class="contain-product contain-product__right-info-layout3">
                                        ...
                                        <div class="info">
                                            <h4 class="product-title"><a href="#" class="pr-name">Nước Ép Trái Cây Vfresh</a></h4>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span class="currencySymbol">đ</span>49.000</span></ins>
                                                <del><span class="price-amount"><span class="currencySymbol">đ</span>69.000</span></del>
                                            </div>
                                            ...
                                            <p class="desc">Thương hiêu Vfresh, Sản xuất tại: Việt Nam, Thành phần: Nước trái cây ép từ nước trái cây cô đặc, hương liệu tổng hợp dùng cho thực phẩm.,.</p>
                                            <div class="buttons">
                                                <a href="#" class="btn add-to-cart-btn" tabindex="0">Đặt hàng ngay</a>
                                ...
                                <li class="product-item">
                                    <div class="contain-product contain-product__right-info-layout3">
                                        ...
                                        <div class="info">
                                            <h4 class="product-title"><a href="#" class="pr-name">Nước Ép Trái Cây Vfresh</a></h4>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span class="currencySymbol">£</span>49.000</span></ins>
                                                <del><span class="price-amount"><span class="currencySymbol">£</span>69.000</span></del>
                                            </div>
                                            <div class="rating">
                                                <p class="star-rating"><span class="width-80percent"></span></p>
                                                <span class="review-count">(08 đánh giá)</span>
                                            </div>
                                            <p class="desc">Thương hiêu Vfresh, Sản xuất tại: Việt Nam, Thành phần: Nước trái cây ép từ nước trái cây cô đặc, hương liệu tổng hợp dùng cho thực phẩm.,.</p>
                                            <div class="buttons">
                                                <a href="#" class="btn add-to-cart-btn" tabindex="0">Đặt hàng ngay</a>
            ...
            <div class="biolife-instagram-block sm-margin-top-76px xs-margin-top-60px">
                <div class="wrap-title xs-margin-bottom-60px-im sm-margin-bottom-35-im">
                    <i class="subtitle hidden-xs">Sử dụng món ăn hàng đầu để có cơ hội được giới thiệu</i>
                    <h3 class="title">Theo dõi chúng tôi trên instagram</h3>
                </div>
